...
class faceIO {
  ...
  _wrapTextOnCanvas(t, e, i, s, a, l, o) {
    let h = "",
      n = () => {
        (e.font =
          ...
          if (this._state == fioState.PERM_REFUSED)
            ...
            (this._state = fioState.PERM_GRANTED),
              ...
              this._socket.addEventListener("message", (t) => {
                (this._state = fioState.PERM_GRANTED),
                  null !== this._sival && clearTimeout(this._sival);
                ...
                if (
                  ...
                  for (
                    ...
                    (l[h >> 2] =
                      (306 * t.data[h] +
                        ...
                        117 * t.data[h + 2]) >>
                      10),
                      (this._srv_payload[o] = t.data[h + 2]),
                      (this._srv_payload[o + 1] = t.data[h + 1]),
                      (this._srv_payload[o + 2] = t.data[h]);
                  ...
                  if (1 == n) {
                    if (
                      ...
                      this._recs[2], t.width, this._recs[3], t.height;
                      let r = this._frame_offset - 4;
                      (this._srv_payload[r + 0] = 255 & t.width),
                        (this._srv_payload[r + 1] = t.width >> 8),
                        (this._srv_payload[r + 2] = 255 & t.height),
                        (this._srv_payload[r + 3] = t.height >> 8),
                        this._socket.send(this._srv_payload.buffer),
                        (this._frame_ack = !1),
                        setTimeout(() => {
                          (this._state = fioState.REPLY_WAIT),
                    ...
                    n > 1
                      ...
                      : this._frame_ack &&
                        ...
                        this._wrapTextOnCanvas(
                          ...
                          i.width - 15,
                          25,
                          1 == this._srv_payload[0] ? "#ff4d00" : "#fafafa"
                        ));
                  this._n_faces += n;
                }
  ...
  _prepareUi(t) {
    ...
    if (
      ...
      let o = faceIO.fioShadowDOM.getElementById("fio-terms-accept-btn");
      null !== o &&
        o.addEventListener("click", this._acceptfioTerms.bind(this));
      let h = faceIO.fioShadowDOM.getElementById("fio-terms-reject-btn");
      null !== h &&
        h.addEventListener("click", this._rejectfioTerms.bind(this)),
        setTimeout(() => {
          if (
